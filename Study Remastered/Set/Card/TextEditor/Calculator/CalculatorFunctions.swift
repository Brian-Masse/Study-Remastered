...
//    }
    ...
    private func updateViewModel(with text: String) -> RichTextFieldViewModel {
        ...
        print("FROM MATH EQUATION: \(parentHandler!.textFieldViewModel.attributedText)")
        
//        textFieldViewModel.attributedText = attributedString
